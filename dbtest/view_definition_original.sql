...
/*
    Create view in DB_SAP, sourcing data from ONE_DB_MITRA
*/
CREATE   VIEW dbo.vw_r_karyawan_jabatan_mapping_preview
AS
WITH base_data AS
(
    SELECT
    ...
    (
        SELECT
            CASE
                ...
                WHEN b.nama_jabatan_norm LIKE '%STAFF%' THEN 'OFF'
                WHEN b.nama_jabatan_norm LIKE '%SECURITY%' THEN 'OFF'
...
(
    SELECT
        CASE
            ...
            OR r.nama_jabatan_norm LIKE '%ADMIN TARINER%'
            OR r.nama_jabatan_norm LIKE '%ADMIN TRAINER%'
            OR r.nama_jabatan_norm LIKE '%ADMIN HR%'
            OR r.nama_jabatan_norm LIKE '%ADMIN HSE%'
            OR r.nama_jabatan_norm LIKE '%DRIVER LV%'
            OR r.nama_jabatan_norm LIKE '%TEKNISI AC%'
            OR r.nama_jabatan_norm LIKE '%ADMIN PLANNER%'
