    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window._initCompanyCharts = function() {
            ...
            createGauge('gaugeComplianceClose', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), true);
            createGauge('gaugeOverdue', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), false);
            createGauge('gaugeComplianceRisk', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), false);
            createGauge('gaugeRRI', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), true);
            createGauge('gaugeRHR', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), false);
            createGauge('gaugeHighRisk', 1.ToString(System.Globalization.CultureInfo.InvariantCulture)), true);
